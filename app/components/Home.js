      ...
      <div className={styles.container}>
        <div>
          <div className={styles.navigationContainer}>
            ...
            <div className={styles.navigationLink}><Link to="/WhoIs"><div><strong>Who</strong> is the appropriate patient for Votrient? <img src="assets/images/forward-arrow.png"/></div></Link></div><br/>
